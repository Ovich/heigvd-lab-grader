...
| 9 | Minor | `README` | `procedure-course-refs.md` and `criteria-work.md` are internal skill working files — moved both under `_mem/` in the lab slug, not exposed to professor. | ✅ |
